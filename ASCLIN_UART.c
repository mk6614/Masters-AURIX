...
#include "BenchmarkIRQPriorities.h"
...
#define ASCLIN                  MODULE_ASCLIN0
#else
#define UART_PIN_TX             IfxAsclin0_TX_P14_0_OUT                  /* UART transmit port pin                   */
#define ASCLIN                  MODULE_ASCLIN0
#endif

//#define UART_RX_BUFFER_SIZE     128                                      /* Definition of the receive buffer size    */
#define UART_TX_BUFFER_SIZE     128                                      /* Definition of the transmit buffer size   */
...
IFX_INTERRUPT(asclin0TxISR, 0, INTPRIO_ASCLIN_TX);
...
void init_ASCLIN_UART(void)
{
    ...
    //ascConfig.interrupt.rxPriority = INTPRIO_ASCLIN0_RX; //input not initialised
    ...
    const IfxAsclin_Asc_Pins pins =
    {
        ...
        NULL_PTR,       IfxPort_InputMode_pullUp,     /* RX pin not used          */
    ...
    IfxCpu_Irq_installInterruptHandler(&asclin0TxISR, INTPRIO_ASCLIN_TX);
#endif
...
void my_printf(const char *fmt, ...)
{
    va_list args;
    va_start(args, fmt);
    g_count = vsprintf(g_txData, fmt, args);
    va_end(args);
